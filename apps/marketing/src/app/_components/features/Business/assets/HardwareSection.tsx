        ...
        <div className="px-8 md:px-16 mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button
              onClick={() => scroll("prev")}
              disabled={!canPrev}
              className="w-12 h-12 rounded-full border cursor-pointer border-white/10 flex items-center justify-center transition-all text-white disabled:opacity-20 disabled:cursor-not-allowed hover:bg-white hover:text-black disabled:hover:bg-transparent"
            >
