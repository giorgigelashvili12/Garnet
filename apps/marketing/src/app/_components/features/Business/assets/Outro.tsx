            ...
            <div className="relative mx-auto max-w-6xl px-6">
                <div className="mx-auto max-w-3xl space-y-8 text-center">
                    ...
                    <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <Button 
                            size="lg" 
                            className="h-12 text-white text-base shadow-[0_0_20px_rgba(120,119,198,0.3)] transition-all hover:scale-105 bg-emerald-500 hover:bg-emerald-600 cursor-pointer"
                        >
                            <Link href="/signup" className='flex items-center px-8'>
                                Get Started Now
