...
const LINE_BASE = { r: 128, g: 128, b: 128, a: 0.15 };
...
export default function InteractiveGrid({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative w-full h-full min-h-[300px] overflow-hidden bg-background rounded-xl border border-border",
        className,
      )}
    >
      <canvas
