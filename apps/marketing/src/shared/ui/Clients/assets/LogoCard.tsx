...
export function LogoCard({ logo }: { logo: Logo }) {
	...
	return (
		<div
			className={cn(
				"group relative grid place-items-center overflow-hidden bg-card cursor-pointer select-none isolate p-3 sm:p-4 min-h-[80px] sm:min-h-[96px]",
				"max-lg:!col-auto max-lg:!row-auto",
		...
		>
			...
			<Svg
				className={cn(
					"relative z-[1] w-auto max-w-[70%] sm:max-w-[65%] transition-all duration-300 group-hover:scale-[1.06]",
					multicolor
						? cn(
				...
				style={{
					height: `clamp(20px, 4vw, ${height}px)`,
					maxHeight: `${height}px`,
				}}
			/>
		</div>
