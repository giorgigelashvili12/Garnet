...
const ACCOUNTS: [string, { name: string; status: string; balance: string }][] = [
    ["1", { name: "Alpha Co", status: "Enabled", balance: "$5,502" }],
    ["2", { name: "Beta Co", status: "Enabled", balance: "$380" }],
    ["3", { name: "Gamma Co", status: "In review", balance: "$933" }],
    ["4", { name: "Delta Co", status: "Enabled", balance: "$168" }],
];
