...
export default function AuthChart({ className }: { className?: string }) {
    const data = [
        ...
        { name: "F", nameFull: "", a: 50, b: 35, c: 15 },
        { name: "M", nameFull: "", a: 40, b: 40, c: 20 },
        { name: "A", nameFull: "", a: 55, b: 25, c: 20 },
        { name: "M", nameFull: "", a: 60, b: 20, c: 20 },
        { name: "J", nameFull: "", a: 50, b: 30, c: 20 },
    ];
